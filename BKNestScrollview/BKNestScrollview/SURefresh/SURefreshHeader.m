...
- (instancetype)init {
    if (self = [super initWithFrame:CGRectMake(0, -SURefreshHeaderHeight, SURefreshHeaderHeight, SURefreshHeaderHeight)]) {
        [self initLayers];
    }
    return self;
}
...
//        self.y = -SURefreshHeaderHeight - contentOffsetY;
    }
}
...
- (void)startAni {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        ...
        for (BKNestBaseController *vc in self.subVCArr) {
