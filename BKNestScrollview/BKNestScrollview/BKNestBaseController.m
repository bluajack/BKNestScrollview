...
@interface BKNestBaseController ()<UITableViewDataSource,UITableViewDelegate>

@property (nonatomic, strong, readwrite) BKNestTableView *tableView;

@end

@implementation BKNestBaseController
...
- (BKNestTableView *)tableView {
    if (_tableView == nil) {
        _tableView = [[BKNestTableView alloc] initWithFrame:self.view.bounds];
